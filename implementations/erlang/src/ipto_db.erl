...
-spec memory_store_unit_json_backend(unit_map()) -> ipto_result(unit_map()).
-spec memory_search_units_backend(search_expression() | map(), search_order(), search_paging()) -> ipto_result(search_result()).
-spec memory_add_relation_backend(unit_ref_value(), relation_type(), unit_ref_value()) -> ok | {error, ipto_reason()}.
-spec memory_remove_relation_backend(unit_ref_value(), relation_type(), unit_ref_value()) -> ok | {error, ipto_reason()}.
-spec memory_get_right_relation_backend(unit_ref_value(), relation_type()) -> relation_lookup_result().
-spec memory_get_right_relations_backend(unit_ref_value(), relation_type()) -> ipto_result([relation()]).
-spec memory_get_left_relations_backend(unit_ref_value(), relation_type()) -> ipto_result([relation()]).
-spec memory_count_right_relations_backend(unit_ref_value(), relation_type()) -> ipto_result(non_neg_integer()).
-spec memory_count_left_relations_backend(unit_ref_value(), relation_type()) -> ipto_result(non_neg_integer()).
-spec memory_add_association_backend(unit_ref_value(), association_type(), ref_string()) -> ok | {error, ipto_reason()}.
-spec memory_remove_association_backend(unit_ref_value(), association_type(), ref_string()) -> ok | {error, ipto_reason()}.
-spec memory_get_right_association_backend(unit_ref_value(), association_type()) -> association_lookup_result().
-spec memory_get_right_associations_backend(unit_ref_value(), association_type()) -> ipto_result([association()]).
-spec memory_get_left_associations_backend(association_type(), ref_string()) -> ipto_result([association()]).
-spec memory_count_right_associations_backend(unit_ref_value(), association_type()) -> ipto_result(non_neg_integer()).
...
-spec pg_search_units_backend(search_expression() | map(), search_order(), search_paging()) -> ipto_result(search_result()).
-spec pg_add_relation_backend(unit_ref_value(), relation_type(), unit_ref_value()) -> ok | {error, ipto_reason()}.
-spec pg_remove_relation_backend(unit_ref_value(), relation_type(), unit_ref_value()) -> ok | {error, ipto_reason()}.
-spec pg_get_right_relation_backend(unit_ref_value(), relation_type()) -> relation_lookup_result().
-spec pg_get_right_relations_backend(unit_ref_value(), relation_type()) -> ipto_result([relation()]).
-spec pg_get_left_relations_backend(unit_ref_value(), relation_type()) -> ipto_result([relation()]).
-spec pg_count_right_relations_backend(unit_ref_value(), relation_type()) -> ipto_result(non_neg_integer()).
-spec pg_count_left_relations_backend(unit_ref_value(), relation_type()) -> ipto_result(non_neg_integer()).
-spec pg_add_association_backend(unit_ref_value(), association_type(), ref_string()) -> ok | {error, ipto_reason()}.
-spec pg_remove_association_backend(unit_ref_value(), association_type(), ref_string()) -> ok | {error, ipto_reason()}.
-spec pg_get_right_association_backend(unit_ref_value(), association_type()) -> association_lookup_result().
-spec pg_get_right_associations_backend(unit_ref_value(), association_type()) -> ipto_result([association()]).
-spec pg_get_left_associations_backend(association_type(), ref_string()) -> ipto_result([association()]).
-spec pg_count_right_associations_backend(unit_ref_value(), association_type()) -> ipto_result(non_neg_integer()).
