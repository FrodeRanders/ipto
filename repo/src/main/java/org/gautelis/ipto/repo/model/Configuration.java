...
public interface Configuration extends Database.Configuration {
    @Configurable(property = "repository.database.adapter", value = "org.gautelis.ipto.repo.db.postgresql.Adapter")
    String databaseAdapter();

    @Configurable(property = "repository.events.threshold", value = /* ActionEvent.Type.CREATED */ "60")
    int eventsThreshold();

    @Configurable(property = "repository.events.listeners", value = "org.gautelis.ipto.repo.listeners.LoggingActionListener")
