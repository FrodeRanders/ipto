...
public class UnitTest {
    ...
    private record Counters(
        ...
        public boolean equals(Object o) {
            if (!(o instanceof Counters counters)) return false;
            return unitCount == counters.unitCount && versionCount == counters.versionCount;
        }
    ...
    @BeforeEach
    public void pre() {
        counters.push(getCounters());
    }

    @AfterEach
    public void post() {
        Counters _pre = counters.pop();
        Counters _post = getCounters();
