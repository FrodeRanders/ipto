...
get_right_association(UnitRef, AssocType) ->
    erepo_db:pg_get_right_association_backend(UnitRef, AssocType).
...
get_right_associations(UnitRef, AssocType) ->
    erepo_db:pg_get_right_associations_backend(UnitRef, AssocType).

-spec get_left_associations(association_type(), ref_string()) -> erepo_result([association()]).
get_left_associations(AssocType, RefString) ->
    erepo_db:pg_get_left_associations_backend(AssocType, RefString).
...
count_right_associations(UnitRef, AssocType) ->
    erepo_db:pg_count_right_associations_backend(UnitRef, AssocType).
...
count_left_associations(AssocType, RefString) ->
    erepo_db:pg_count_left_associations_backend(AssocType, RefString).
