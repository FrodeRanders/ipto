...
\hline
PostgreSQL test DB setup & \texttt{python shared/db/postgresql/setup-for-test.py} \\
\hline
DB2 test DB setup & \texttt{python shared/db/db2/setup-for-test.py} \\
\hline
Java unit tests & \texttt{mvn -f implementations/java/pom.xml -q test} \\
\hline
Java integration tests & \texttt{mvn -f implementations/java/pom.xml -pl it verify} \\
\hline
...
\hline
Rust Python tests & \texttt{python -m pytest -q python\_tests/test\_ipto.py} \\
\hline
