...
CREATE INDEX repo_uv_ind1 ON repo_unit_version (
    tenantid, unitid, unitver, modified
) INCLUDE (unitname);
;
...
CREATE TABLE repo_attribute_value (
    ...
    attrver INTEGER NOT NULL,  -- version of attribute
    ...
    CONSTRAINT repo_attribute_value_pk
        ...
        PRIMARY KEY (tenantid, unitid, attrid, attrver, unitverfrom),
