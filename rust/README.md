...
- Reuse existing GraphQL SDL conventions from `Specification.graphql` and `graphql/`.
...
- map unit JSON model to existing SQL schema and procedures in `db/postgresql`
